'''
[Code Provided by the tutorial of https://github.com/thenomaniqbal/Traffic-flow-prediction/blob/master/Traffic_prediction.ipynb]
...
class WindowGenerator():
  ...
  def __init__(self, input_width, label_width, shift, train_df, val_df, test_df, batch_size=32, label_columns=None):
    # Store the raw data.
